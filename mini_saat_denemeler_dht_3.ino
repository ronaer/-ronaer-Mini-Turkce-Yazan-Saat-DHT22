...
Original: Mini Clock v1.0, Jul 2014 by Nick Hall
...
FC16 modül kullanıldı - Using FC16Hardware  MAX72xx Matrixes 
FC16 ile görüntülemne sorunları giderildi - Corrected miror efect with using FC16
Ay gün hafta isimleri Türkçe'ye çevrildi - Translated daynames, monthnames, etc. to Turkish
Yaz kış saati uygulaması kaldırıldı - Summer and winter time is removed
DHT 22 kullanıldı ve saatimiz derece ve nem ölçer fonksiyonu kazandı
...
#include <DHT.h>  // DHT kütüphanesi ekleyelim ve sensor tanımlayalım
#define DHTPIN 9
...
char daysfull[7][9] = {
  "Pazar", "Pzartesi", "Sali", "Carsamba", "Persembe", "Cuma", "Cmartesi"
};
...
//  get_time(); //get the time from the clock chip
  ...
  while (run_mode()) {
    ...
    if (hours == 0) { hours = 12; }
      ...
      if ( wordHour == 1 )      { strcpy (str_a, "BIR'I");}
      else if ( wordHour == 2 ) { strcpy (str_a, "IKI'YI"); } 
      else if ( wordHour == 3 ) { strcpy (str_a, "~C'~"); } 
      else if ( wordHour == 4 ) { strcpy (str_a, "D*RT'~"); }
      else if ( wordHour == 5 ) { strcpy (str_a, "BES'I"); } 
      else if ( wordHour == 6 ) { strcpy (str_a, "ALTI'YI"); } 
      else if ( wordHour == 7 ) { strcpy (str_a, "YEDI'YI"); }
      else if ( wordHour == 8 ) { strcpy (str_a, "SEKIZ'I"); } 
      else if ( wordHour == 9 ) { strcpy (str_a, "DOKUZ'U"); } 
      else if ( wordHour == 10) { strcpy (str_a, "ON'U"); }
      else if ( wordHour == 11) { strcpy (str_a, "ONBiR'I"); } 
      else if ( wordHour == 12) { strcpy (str_a, "ONIKI'YI"); } 

       if      (mins >= 5 && mins <= 9)  { strcpy (str_b, "BES");      strcpy (str_d, "geciyor"); strcpy (str_c, ""); }
       else if (mins >= 10 && mins <= 14){ strcpy (str_b, "ON");       strcpy (str_d, "geciyor"); strcpy (str_c, ""); }
       else if (mins >= 15 && mins <= 19){ strcpy (str_b, "ONBES");    strcpy (str_d, "geciyor"); strcpy (str_c, ""); }
       else if (mins >= 20 && mins <= 24){ strcpy (str_b, "YiRMi");    strcpy (str_d, "geciyor"); strcpy (str_c, ""); }      
       else if (mins >= 25 && mins <= 29){ strcpy (str_b, "YRMIBES");   strcpy (str_d, "geciyor"); strcpy (str_c, ""); }      
       else if (mins >= 30 && mins <= 34){ strcpy (str_b, "OTUZ");     strcpy (str_d, "geciyor"); strcpy (str_c, ""); }      
       else if (mins >= 35 && mins <= 39){ strcpy (str_b, "OTUZBES");  strcpy (str_d, "geciyor"); strcpy (str_c, ""); }      
       else if (mins >= 40 && mins <= 44){ strcpy (str_b, "KIRK");     strcpy (str_d, "geciyor"); strcpy (str_c, ""); }       
       else if (mins >= 45 && mins <= 49){ strcpy (str_b, "KIRKBES");  strcpy (str_d, "geciyor"); strcpy (str_c, ""); }     
       else if (mins >= 50 && mins <= 54){ strcpy (str_b, "ELLI dk");  strcpy (str_d, "geciyor"); strcpy (str_c, ""); }       
       else if (mins >= 55 && mins <= 59){ strcpy (str_b, "ELLIBES");  strcpy (str_d, "geciyor"); strcpy (str_c, ""); } 

      
      if (mins <= 4 &&  wordHour == 1 ){strcpy (str_a, ""); strcpy (str_d, "");strcpy (str_c, "");strcpy (str_b, "BIR");strcpy (str_e, "");}
      else if ( mins <= 4 && wordHour == 2 ) { strcpy (str_a, ""); strcpy (str_d, ""); strcpy (str_c, ""); strcpy (str_b, "IKI"); strcpy (str_e, "");} 
      else if ( mins <= 4 && wordHour == 3 ) { strcpy (str_a, ""); strcpy (str_d, ""); strcpy (str_c, ""); strcpy (str_b, "~C"); strcpy (str_e, "");} 
      else if ( mins <= 4 && wordHour == 4 ) { strcpy (str_a, ""); strcpy (str_d, ""); strcpy (str_c, ""); strcpy (str_b, "D*RT"); strcpy (str_e, "");} 
      else if ( mins <= 4 && wordHour == 5 ) { strcpy (str_a, ""); strcpy (str_d, ""); strcpy (str_c, ""); strcpy (str_b, "BES"); strcpy (str_e, "");} 
      else if ( mins <= 4 && wordHour == 6 ) { strcpy (str_a, ""); strcpy (str_d, ""); strcpy (str_c, ""); strcpy (str_b, "ALTI"); strcpy (str_e, "");} 
      else if ( mins <= 4 && wordHour == 7 ) { strcpy (str_a, ""); strcpy (str_d, ""); strcpy (str_c, ""); strcpy (str_b, "YEDI"); strcpy (str_e, "");} 
      else if ( mins <= 4 && wordHour == 8 ) { strcpy (str_a, ""); strcpy (str_d, ""); strcpy (str_c, ""); strcpy (str_b, "SEKIZ"); strcpy (str_e, "");} 
      else if ( mins <= 4 && wordHour == 9 ) { strcpy (str_a, ""); strcpy (str_d, ""); strcpy (str_c, ""); strcpy (str_b, "DOKUZ"); strcpy (str_e, "");} 
      else if ( mins <= 4 && wordHour == 10) { strcpy (str_a, ""); strcpy (str_d, ""); strcpy (str_c, ""); strcpy (str_b, "ON"); strcpy (str_e, "");} 
      else if ( mins <= 4 && wordHour == 11) { strcpy (str_a, ""); strcpy (str_d, ""); strcpy (str_c, ""); strcpy (str_b, "ONBIR"); strcpy (str_e, "");} 
      else if ( mins <= 4 && wordHour == 12) { strcpy (str_a, ""); strcpy (str_d, ""); strcpy (str_c, ""); strcpy (str_b, "ONIKI"); strcpy (str_e, "");} 
      else{
         strcpy (str_e, "");        
      }
...
char temp[6]; //derece
  ...
  byte offset1 = 6;      
  puttinychar(0+offset1, 1, temp[0]);   //print the 1st temp number (10 degrees)
  delay(date_delay);
  puttinychar(4+offset1, 1, temp[1]);   //print the 2nd temp number (1 degrees)
  delay(date_delay);
  puttinychar(8+offset1, 1, temp[2]);   //print the 3rd temp number (.)
  delay(date_delay);
  puttinychar(10+offset1, 1, temp[3]);  //print the 4th temp number (first decimal place)
  delay(date_delay);
  puttinychar(14+offset1, 1, temp[4]);  //print degree-symbol
  delay(date_delay);
  puttinychar(18+offset1, 1, temp[5]);  //print the 6th temp number C(elsius)
  ...
  char buffer_n[4] = "nem:";
  byte offset = 2; 
  puttinychar(0+offset, 1, buffer_n[0]);  //print n
  delay(date_delay);
  puttinychar(4+offset, 1, buffer_n[1]);  //print e
    delay(date_delay); 
   puttinychar(8+offset, 1, buffer_n[2]);  //print m
  delay(date_delay);  
  puttinychar(11+offset, 1, buffer_n[3]);  //print :
  delay(date_delay);  
  puttinychar(15+offset, 1, tempC[0]);   //print the 1st temp number (10 degrees)
  delay(date_delay);
  puttinychar(19+offset, 1, tempC[1]);   //print the 2nd temp number (1 degrees)
  delay(date_delay);
  puttinychar(23+offset, 1, tempC[2]);   //print the 3rd temp number (.)
  delay(date_delay);
  puttinychar(25+offset, 1, tempC[3]);  //print the 4th temp number (first decimal place)
  delay(date_delay);
...
void display_date(){
  ...
  //array of month names to print on the display that are shortened as we only have 8 characters across to play with
  ...
  //----------- print week of year ----------- //
  offset = 1;
  char buffer_w[6] = "Hafta:";
  puttinychar(0+offset , 1, buffer_w[0]);   //print "H"
  delay(date_delay);
  puttinychar(4+offset , 1, buffer_w[1]);   //print "a"
  delay(date_delay);
  puttinychar(8+offset , 1, buffer_w[2]);   //print "f"
  delay(date_delay);
  puttinychar(12+offset , 1, buffer_w[3]);   //print "t"
  delay(date_delay);
  puttinychar(16+offset , 1, buffer_w[4]);   //print "a"
  delay(date_delay);
  puttinychar(19+offset , 1, buffer_w[5]);   //print ":"
  delay(date_delay);
...
void get_time()
{
  ...
  rtc[5] = now.month();
  rtc[4] = now.day();
  rtc[3] = now.dayOfTheWeek(); //returns 0-6 where 0 = Sunday ; old_lib: now.dayOfWeek();
...
char measure_Temp(){
  ...
  float TempC = dht.readHumidity();
  String stringTemp = "";           //data in buffer is copied to this string  
  dtostrf(temp, 4, 1, tempid);  //4 is mininum width, 1 is precision; float value is copied to buffer
  ...
  dtostrf(TempC, 4, 1, tempi);       //4 is mininum width, 1 is precision; float value is copied to buffer
      ...
      if (debug){
        ...
        Serial.println(dht.readHumidity()); // the first temp-sensor on I2C
        ...
        Serial.println("");       
         ...
         Serial.println("");
        Serial.print("Temperatur: ");
        Serial.println(dht.readTemperature()); // the first temp-sensor on I2C
        Serial.print("          tempid[0]: ");
        Serial.println(tempi[0]);
        Serial.print("          tempid[1]: ");
        Serial.println(tempi[1]);
        Serial.print("          tempid[2]: ");
        Serial.println(tempi[2]);
        Serial.print("          tempid[3]: ");
        Serial.println(tempid[3]);
        Serial.println("");        
      }

   return  tempi[0], tempi[1], tempi[2], tempi[3] ;   
   return  tempid[0], tempid[1], tempid[2], tempid[3] ;  
}
